...
| Lesson | Title | Time |
|---|---|---|
| [1.1](./lesson-1-1-demystifying-ai.md) | Demystifying the Technology | 15 min |
| [1.2](./lesson-1-2-ai-ecosystem-map.md) | The AI Ecosystem Map | 20 min |
| [1.3](./lesson-1-3-business-use-cases.md) | How Businesses Are Actually Using AI Today | 15 min |
| [Exercise](./exercise.md) | Reflection: Map Your Own AI Opportunities | 10 min |
